...
Source0  : https://files.pythonhosted.org/packages/19/f1/1c1dc0f6b3bf9e76f7526562d29c320fa7d6a2f35b37a1392cc0acd58263/jsonschema-4.22.0.tar.gz
...
%prep
%setup -q -n jsonschema-4.22.0
cd %{_builddir}/jsonschema-4.22.0
pushd ..
cp -a jsonschema-4.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720053589
